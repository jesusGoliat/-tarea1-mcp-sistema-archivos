...
Tres herramientas reales, actualmente en uso, que implementan MCP:
...
- Google Developers Blog. (s.f.). *Build with Google Antigravity, our new agentic development platform*. Recuperado en septiembre de 2026, de https://developers.googleblog.com/build-with-google-antigravity-our-new-agentic-development-platform/
- Google Cloud Blog. (s.f.). *Connect Google Antigravity IDE to Google's Data Cloud services*. Recuperado en septiembre de 2026, de https://cloud.google.com/blog/products/data-analytics/connect-google-antigravity-ide-to-googles-data-cloud-services
- Cursor. (s.f.). *Model Context Protocol*. Recuperado en septiembre de 2026, de https://cursor.com/docs/context/mcp
